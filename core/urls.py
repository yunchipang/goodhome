...
from bid.views import home, upload_property, get_properties, get_csrf, get_property_details, get_auction_result, get_winner_by_auction, rate_winner, shipping_create
